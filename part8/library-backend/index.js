...
const MONGODB_URI = `mongodb+srv://root:${MONGO_PWD}@cluster0.l8ugpt5.mongodb.net/?retryWrites=true&w=majority`;
    ...
    allBooks: async (root, args) => {
      if (args.author) {
        ...
        if (foundAuthor) {
          ...
          return Book.find({ author: foundAuthor.id }).populate('author');
        }
        return null;
      }
